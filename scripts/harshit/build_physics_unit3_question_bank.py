#!/usr/bin/env python3
"""Build Harshit Physics Unit 3 question bank (200 MCQs from concept cards)."""
...
# Reuse generators from unit 2 builder pattern
from scripts.harshit.build_physics_unit2_question_bank import (  # noqa: E402
    GENERATORS,
    _distractors,
...
UNIT_ID = 3
TARGET_TOTAL = 200
BANK_PATH = ROOT / "HarshitPhysics" / "unit3" / "question_bank.json"
