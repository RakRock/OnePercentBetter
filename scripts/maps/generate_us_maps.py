...
GEOJSON_PATH = os.path.join(str(Path(__file__).resolve().parents[2]), us_states.geojson"
STATE_MAPS_DIR = os.path.join(str(Path(__file__).resolve().parents[2]), us_state_maps"
US_MAP_DIR = os.path.join(str(Path(__file__).resolve().parents[2]), us_map"
BOUNDS_PATH = os.path.join(str(Path(__file__).resolve().parents[2]), us_state_bounds.json"
