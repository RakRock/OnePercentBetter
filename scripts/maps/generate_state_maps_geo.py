...
GEOJSON_PATH = os.path.join(str(Path(__file__).resolve().parents[2]), india_adarsh.geojson"
STATE_MAPS_DIR = os.path.join(str(Path(__file__).resolve().parents[2]), state_maps"
INDIA_MAP_DIR = os.path.join(str(Path(__file__).resolve().parents[2]), india_map"
BOUNDS_PATH = str(Path(__file__).resolve().parents[2] / "state_bounds.json")
