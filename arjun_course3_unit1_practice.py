...
UNIT1_QUESTION_BANK: list[dict] = [
    ...
    # ── Powers & roots (5) ──
    {
        ...
        "question": "A square has a side length of 7.2 inches. What is its area in square inches?",
        "options": ["14.4 in²", "51.84 in²", "28.8 in²", "72 in²"],
        "answer": 1,
        "explanation": "Area of a square = side² = 7.2² = 51.84 in².",
    },
    {
        "id": "u1_pow2", "category": "powers_roots",
        "question": (
            "A square tile has area x² = 81 cm². "
            "What is the positive side length x?"
        ),
        "options": ["8 cm", "9 cm", "81 cm", "±9 cm (two answers)"],
        "answer": 1,
        "explanation": "9² = 81. Use 9 cm for a single side length.",
    },
    {
        "id": "u1_pow3", "category": "powers_roots",
        "question": (
            "A square has area 16 cm², so each side is 4 cm long. "
            "If you shorten each side by 1 cm, what is the new area?"
        ),
        "options": ["9 cm²", "4 cm²", "8 cm²", "12 cm²"],
        "answer": 0,
        "explanation": "New side length is 3 cm. New area = 3² = 9 cm².",
    },
    {
        "id": "u1_pow4", "category": "powers_roots",
        "question": "A cube has volume 216 ft³. How long is each edge?",
        "options": ["6 ft", "36 ft", "72 ft", "18 ft"],
        "answer": 0,
        "explanation": "6³ = 216, so each edge is 6 ft.",
    },
    {
        "id": "u1_pow5", "category": "powers_roots",
        "question": "Which expression is NOT equal to 8² (which is 64)?",
        "options": ["64", "8 × 8", "8 multiplied by 2", "2⁶"],
        "answer": 2,
    ...
    # ── Rational numbers (5) ──
    {
        ...
        "question": "Write 3/5 as a decimal and as a percent.",
    ...
    },
    {
        ...
        "question": "Write 0.8 as a fraction in simplest form and as a percent.",
    ...
    },
    {
        ...
        "question": "Which value is NOT equivalent to the fraction 60/80?",
        "options": ["3/4", "0.75", "0.6", "75%"],
        "answer": 2,
        "explanation": "60/80 = 3/4 = 0.75 = 75%. The value 0.6 is different.",
    },
    {
        "id": "u1_rat4", "category": "rational_numbers",
        "question": "Write 1/9 as a decimal.",
        "options": ["0.9", "0.111… (repeating)", "0.19", "0.1 (terminates)"],
        "answer": 1,
        "explanation": "1 ÷ 9 = 0.111…, a repeating decimal.",
    },
    {
        "id": "u1_rat5", "category": "rational_numbers",
        "question": "Which number is NOT rational (cannot be written as a fraction)?",
        "options": ["0.75", "0.333… (repeating)", "π", "−4/5"],
        "answer": 2,
    ...
    # ── Irrational numbers (5) ──
    {
        ...
        "answer": 1,
        "explanation": "√18 is between √16 = 4 and √25 = 5. √18 ≈ 4.24 → about 4.2.",
    },
    {
        "id": "u1_irr2", "category": "irrational_numbers",
        "question": "Which value is NOT between 5 and 6 on the number line?",
        "options": ["√27", "√32", "√29", "√37"],
        "answer": 3,
        "explanation": "√37 ≈ 6.08, which is greater than 6.",
    },
    {
        "id": "u1_irr3", "category": "irrational_numbers",
        "question": "Which of these is a rational number (not irrational)?",
        "options": ["√45", "√78", "√16", "π"],
        "answer": 2,
        "explanation": "√16 = 4, which is a whole number and rational.",
    },
    {
        "id": "u1_irr4", "category": "irrational_numbers",
        "question": "Order from least to greatest: √24, 5, √27, and 5.5",
        "options": [
            "5, √24, √27, 5.5",
            "√24, 5, √27, 5.5",
            "√24, √27, 5, 5.5",
        ...
        "answer": 1,
        "explanation": "√24 ≈ 4.9, √27 ≈ 5.2, so the order is √24, 5, √27, 5.5.",
    },
    {
        "id": "u1_irr5", "category": "irrational_numbers",
        "question": (
            "From the set {5/6, 2.1, √45, √78, 2/3}, which numbers are irrational?"
        ),
        "options": ["5/6 and 2/3", "√45 and √78", "2.1 only", "All of them"],
        "answer": 1,
        "explanation": "√45 and √78 are not perfect squares, so they are irrational.",
    },
    # ── Exponents (5) ──
    {
        "id": "u1_exp1", "category": "exponents",
        "question": "Multiply and write with one power of 3: 3⁵ · 3⁴",
        "options": ["3¹", "3⁹", "3²⁰", "9⁹"],
        "answer": 1,
        "explanation": "Same base → add exponents: 3⁵⁺⁴ = 3⁹.",
    },
    {
        "id": "u1_exp2", "category": "exponents",
        "question": "Divide and write with one power of x: x¹¹ ÷ x⁴",
        "options": ["x⁴⁴", "x⁷", "x¹⁵", "x⁴"],
        "answer": 1,
        "explanation": "Same base → subtract exponents: x¹¹⁻⁴ = x⁷.",
    },
    {
        "id": "u1_exp3", "category": "exponents",
        "question": "Kwon says 5⁵ · 5⁴ = 5¹. Is Kwon correct?",
        "options": [
            "Yes, he is correct",
            "No — the answer should be 5⁹",
            "No — the answer should be 25⁹",
            "No — the answer should be 5²⁰",
        ],
        "answer": 1,
        "explanation": "When multiplying same base, add exponents: 5⁵⁺⁴ = 5⁹.",
    },
    {
    ...
    },
    {
        ...
        "question": "Multiply and write with one power of t: t² · t⁵",
        "options": ["t¹⁰", "t⁷", "t³", "2t⁷"],
        "answer": 1,
        "explanation": "Add exponents: t²⁺⁵ = t⁷.",
    },
    # ── Scientific notation (5) ──
    {
        ...
        "answer": 1,
        "explanation": "Move the decimal 10 places → 2.5 × 10¹⁰.",
    },
    {
        "id": "u1_sci2", "category": "scientific_notation",
        "question": "Write 7 × 10² in standard (regular) form.",
        "options": ["70", "700", "7000", "0.7"],
        "answer": 1,
        "explanation": "Move the decimal 2 places to the right → 700.",
    },
    {
        ...
        "options": [
            "Yes",
            "No — rewrite as 1.02 × 10⁵",
            "No — rewrite as 102 × 10³",
            "No — the exponent should be 10⁴, not 10⁵",
        ],
        "answer": 1,
        "explanation": "In scientific notation, the coefficient must satisfy 1 ≤ |a| < 10.",
    },
    {
        "id": "u1_sci4", "category": "scientific_notation",
        "question": "Write 9,200,000,000,000,000 in scientific notation.",
    ...
    },
    {
        ...
        "question": "Write 8.6 × 10⁻⁵ in standard (regular) form.",
    ...
    # ── Sci notation operations (4) ──
    {
        ...
        "question": "Multiply: (2.2 × 10⁵)(4 × 10⁷). Write the result in scientific notation.",
        "options": ["8.8 × 10¹²", "6.2 × 10¹²", "8.8 × 10³⁵", "88 × 10¹²"],
        "answer": 0,
        "explanation": "Multiply coefficients (2.2 × 4 = 8.8) and add exponents (5 + 7 = 12).",
    },
    {
        "id": "u1_scio2", "category": "sci_notation_ops",
        "question": "Divide: (7.4 × 10⁶) ÷ (5 × 10⁻²). Write the result in scientific notation.",
        "options": ["1.48 × 10⁸", "1.48 × 10⁴", "14.8 × 10⁷", "1.48 × 10⁶"],
        "answer": 0,
        "explanation": "7.4 ÷ 5 = 1.48; subtract exponents: 6 − (−2) = 8.",
    },
    {
        ...
        "answer": 2,
        "explanation": "Same power of 10 → 12.5 × 10⁵, which equals 1.25 × 10⁶.",
    },
    {
        "id": "u1_scio4", "category": "sci_notation_ops",
        "question": "Subtract: 7.5 × 10⁻³ − 2.1 × 10⁻³",
