"""Streamlit UI — Harshit Physics Confidence, Unit 1 (Light)."""
...
import harshit_physics_state as hps
...
def render_home() -> None:
    ...
    st.markdown(
        ...
        <div style="background:#EEF1F5;padding:1.25rem;border-radius:8px;border-left:4px solid #6366F1;">
          <strong>Physics Confidence</strong> — understand and visualize before practice.
