"""Generate Physics Unit 1 MCQs via xAI Grok, seeded from the 200-question bank."""
...
- Plain language — no LaTeX. Use cm, m, D (dioptre) where needed.
- Short explanation (1-2 sentences) referencing the physics idea.
- Use SEED EXAMPLES as style/format guides — write NEW questions, do not copy them.
- For mirror/lens numericals, use realistic NCERT-style values and correct sign conventions.

Respond with ONLY a valid JSON array:
[
  {"question": "...", "options": ["...", "...", "...", "..."], "answer": 0, "explanation": "...", "chapter_ref": "NCERT Ch 9"}
]"""
        ...
        validated.append(
            {
                ...
                "chapter_ref": str(q.get("chapter_ref", "NCERT Ch 9 — Light")).strip(),
                "source": "chapter_llm",
            }
        )
    return validated
